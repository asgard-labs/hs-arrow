...
-- ==== Methods
-- [append]("GI.Arrow.Objects.Int32ArrayBuilder#g:method:append"), [appendEmptyValue]("GI.Arrow.Objects.ArrayBuilder#g:method:appendEmptyValue"), [appendEmptyValues]("GI.Arrow.Objects.ArrayBuilder#g:method:appendEmptyValues"), [appendNull]("GI.Arrow.Objects.ArrayBuilder#g:method:appendNull"), [appendNulls]("GI.Arrow.Objects.ArrayBuilder#g:method:appendNulls"), [appendValue]("GI.Arrow.Objects.Int32ArrayBuilder#g:method:appendValue"), [appendValues]("GI.Arrow.Objects.Int32ArrayBuilder#g:method:appendValues"), [bindProperty]("GI.GObject.Objects.Object#g:method:bindProperty"), [bindPropertyFull]("GI.GObject.Objects.Object#g:method:bindPropertyFull"), [finish]("GI.Arrow.Objects.ArrayBuilder#g:method:finish"), [forceFloating]("GI.GObject.Objects.Object#g:method:forceFloating"), [freezeNotify]("GI.GObject.Objects.Object#g:method:freezeNotify"), [getv]("GI.GObject.Objects.Object#g:method:getv"), [isFloating]("GI.GObject.Objects.Object#g:method:isFloating"), [notify]("GI.GObject.Objects.Object#g:method:notify"), [notifyByPspec]("GI.GObject.Objects.Object#g:method:notifyByPspec"), [ref]("GI.GObject.Objects.Object#g:method:ref"), [refSink]("GI.GObject.Objects.Object#g:method:refSink"), [reserve]("GI.Arrow.Objects.ArrayBuilder#g:method:reserve"), [reset]("GI.Arrow.Objects.ArrayBuilder#g:method:reset"), [resize]("GI.Arrow.Objects.ArrayBuilder#g:method:resize"), [runDispose]("GI.GObject.Objects.Object#g:method:runDispose"), [stealData]("GI.GObject.Objects.Object#g:method:stealData"), [stealQdata]("GI.GObject.Objects.Object#g:method:stealQdata"), [thawNotify]("GI.GObject.Objects.Object#g:method:thawNotify"), [unref]("GI.GObject.Objects.Object#g:method:unref"), [watchClosure]("GI.GObject.Objects.Object#g:method:watchClosure").
-- 
-- ==== Getters
...
instance SP.ManagedPtrNewtype Int32ArrayBuilder where
    toManagedPtr (Int32ArrayBuilder p) = p

foreign import ccall "garrow_int32_array_builder_get_type"
    c_garrow_int32_array_builder_get_type :: IO B.Types.GType

instance B.Types.TypedObject Int32ArrayBuilder where
    glibType = c_garrow_int32_array_builder_get_type
...
toInt32ArrayBuilder = MIO.liftIO . B.ManagedPtr.unsafeCastTo Int32ArrayBuilder

-- | Convert 'Int32ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue'. See 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue (Maybe Int32ArrayBuilder) where
    gvalueGType_ = c_garrow_int32_array_builder_get_type
    gvalueSet_ gv P.Nothing = B.GValue.set_object gv (FP.nullPtr :: FP.Ptr Int32ArrayBuilder)
    gvalueSet_ gv (P.Just obj) = B.ManagedPtr.withManagedPtr obj (B.GValue.set_object gv)
    gvalueGet_ gv = do
        ptr <- B.GValue.get_object gv :: IO (FP.Ptr Int32ArrayBuilder)
        if ptr /= FP.nullPtr
        then P.Just <$> B.ManagedPtr.newObject Int32ArrayBuilder ptr
...
type family ResolveInt32ArrayBuilderMethod (t :: Symbol) (o :: *) :: * where
    ...
    ResolveInt32ArrayBuilderMethod "appendEmptyValue" o = Arrow.ArrayBuilder.ArrayBuilderAppendEmptyValueMethodInfo
    ResolveInt32ArrayBuilderMethod "appendEmptyValues" o = Arrow.ArrayBuilder.ArrayBuilderAppendEmptyValuesMethodInfo
    ResolveInt32ArrayBuilderMethod "appendNull" o = Arrow.ArrayBuilder.ArrayBuilderAppendNullMethodInfo
    ResolveInt32ArrayBuilderMethod "appendNulls" o = Arrow.ArrayBuilder.ArrayBuilderAppendNullsMethodInfo
    ...
    ResolveInt32ArrayBuilderMethod "reserve" o = Arrow.ArrayBuilder.ArrayBuilderReserveMethodInfo
    ResolveInt32ArrayBuilderMethod "reset" o = Arrow.ArrayBuilder.ArrayBuilderResetMethodInfo
    ResolveInt32ArrayBuilderMethod "resize" o = Arrow.ArrayBuilder.ArrayBuilderResizeMethodInfo
    ...
    ResolveInt32ArrayBuilderMethod "getCapacity" o = Arrow.ArrayBuilder.ArrayBuilderGetCapacityMethodInfo
    ResolveInt32ArrayBuilderMethod "getData" o = GObject.Object.ObjectGetDataMethodInfo
    ResolveInt32ArrayBuilderMethod "getLength" o = Arrow.ArrayBuilder.ArrayBuilderGetLengthMethodInfo
    ResolveInt32ArrayBuilderMethod "getNNulls" o = Arrow.ArrayBuilder.ArrayBuilderGetNNullsMethodInfo
...
instance (info ~ ResolveInt32ArrayBuilderMethod t Int32ArrayBuilder, O.OverloadedMethod info Int32ArrayBuilder p) => OL.IsLabel t (Int32ArrayBuilder -> p) where
...
instance (info ~ ResolveInt32ArrayBuilderMethod t Int32ArrayBuilder, O.OverloadedMethod info Int32ArrayBuilder p, R.HasField t Int32ArrayBuilder p) => R.HasField t Int32ArrayBuilder p where
    getField = O.overloadedMethod @info

#endif

instance (info ~ ResolveInt32ArrayBuilderMethod t Int32ArrayBuilder, O.OverloadedMethodInfo info Int32ArrayBuilder) => OL.IsLabel t (O.MethodProxy info Int32ArrayBuilder) where
#if MIN_VERSION_base(4,10,0)
...
instance (signature ~ (Int32 -> m ()), MonadIO m, IsInt32ArrayBuilder a) => O.OverloadedMethod Int32ArrayBuilderAppendMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppend

instance O.OverloadedMethodInfo Int32ArrayBuilderAppendMethodInfo a where
    overloadedMethodInfo = P.Just (O.ResolvedSymbolInfo {
        O.resolvedSymbolName = "GI.Arrow.Objects.Int32ArrayBuilder.int32ArrayBuilderAppend",
        O.resolvedSymbolURL = "https://hackage.haskell.org/package/gi-arrow-9.0/docs/GI-Arrow-Objects-Int32ArrayBuilder.html#v:int32ArrayBuilderAppend"
        })
...
instance (signature ~ (Int32 -> m ()), MonadIO m, IsInt32ArrayBuilder a) => O.OverloadedMethod Int32ArrayBuilderAppendValueMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppendValue

instance O.OverloadedMethodInfo Int32ArrayBuilderAppendValueMethodInfo a where
    overloadedMethodInfo = P.Just (O.ResolvedSymbolInfo {
        O.resolvedSymbolName = "GI.Arrow.Objects.Int32ArrayBuilder.int32ArrayBuilderAppendValue",
        O.resolvedSymbolURL = "https://hackage.haskell.org/package/gi-arrow-9.0/docs/GI-Arrow-Objects-Int32ArrayBuilder.html#v:int32ArrayBuilderAppendValue"
        })
...
instance (signature ~ ([Int32] -> Maybe ([Bool]) -> m ()), MonadIO m, IsInt32ArrayBuilder a) => O.OverloadedMethod Int32ArrayBuilderAppendValuesMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppendValues

instance O.OverloadedMethodInfo Int32ArrayBuilderAppendValuesMethodInfo a where
    overloadedMethodInfo = P.Just (O.ResolvedSymbolInfo {
        O.resolvedSymbolName = "GI.Arrow.Objects.Int32ArrayBuilder.int32ArrayBuilderAppendValues",
        O.resolvedSymbolURL = "https://hackage.haskell.org/package/gi-arrow-9.0/docs/GI-Arrow-Objects-Int32ArrayBuilder.html#v:int32ArrayBuilderAppendValues"
        })
